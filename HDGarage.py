...
dataset_train.load_data('dataset/train/labels/instances_default.json', 'dataset/train/images')
dataset_train.prepare()

#In this example, I do not have annotations for my validation data, so I am loading train data
dataset_val = CocoLikeDataset()
dataset_val.load_data('dataset/train/labels/instances_default.json', 'dataset/train/images')
dataset_val.prepare()
